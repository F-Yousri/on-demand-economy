class OrdersController < ApplicationController
    ...
    def show
        ...
        response={message: Message.success ,history_pages: history_pages, history: history_orders,active: active_orders ,upcoming: upcomig_orders,images: []}
    ...
    def order_params
        params.permit(:src_latitude,:src_longitude,:dest_latitude,:dest_longitude,:provider_id,:payment_method,:time,:title,:arr, :weight,:description,images: [])
    end
end
